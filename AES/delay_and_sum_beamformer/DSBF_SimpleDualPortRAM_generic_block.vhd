-- -------------------------------------------------------------
-- 
-- File Name: D:\NIH3Repo\simulink_models\models\delay_and_sum_beamformer\hdlsrc\DSBF\DSBF_SimpleDualPortRAM_generic_block.vhd
-- 
...
-- -------------------------------------------------------------
-- 
-- Module: DSBF_SimpleDualPortRAM_generic_block
-- Source Path: DSBF/dataplane/Avalon Data Processing/delay signals/delay signal/SimpleDualPortRAM_generic
-- Hierarchy Level: 4
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY DSBF_SimpleDualPortRAM_generic_block IS
...
END DSBF_SimpleDualPortRAM_generic_block;


ARCHITECTURE rtl OF DSBF_SimpleDualPortRAM_generic_block IS
