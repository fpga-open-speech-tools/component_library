-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\wickh\Documents\NIH\simulink_models\models\fft_filters\hdlsrc\fft_filters\fft_filters_Analysis.vhd
-- 
...
-- -------------------------------------------------------------
-- 
-- Module: fft_filters_Analysis
-- Source Path: fft_filters/dataplane/FFT_Analysis_Synthesis_Left/Analysis
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
END fft_filters_Analysis;


ARCHITECTURE rtl OF fft_filters_Analysis IS
  ...
  FOR ALL : fft_filters_FFT_Frame_Buffering
    USE ENTITY work.fft_filters_FFT_Frame_Buffering(rtl);

  FOR ALL : fft_filters_FFT
    USE ENTITY work.fft_filters_FFT(rtl);
