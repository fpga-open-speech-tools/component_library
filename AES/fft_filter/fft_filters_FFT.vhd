-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\wickh\Documents\NIH\simulink_models\models\fft_filters\hdlsrc\fft_filters\fft_filters_FFT.vhd
-- 
...
-- -------------------------------------------------------------
-- 
-- Module: fft_filters_FFT
-- Source Path: fft_filters/dataplane/FFT_Analysis_Synthesis_Left/Analysis/FFT
-- Hierarchy Level: 3
-- 
-- FFT HDL Optimized
-- 
...
ARCHITECTURE rtl OF fft_filters_FFT IS

  -- Component Declarations
  COMPONENT fft_filters_TWDLROM
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
  ...
  COMPONENT fft_filters_MINRESRX2FFT_MEMORY
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
  ...
  COMPONENT fft_filters_MINRESRX2FFT_BTFSEL
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
  ...
  COMPONENT fft_filters_MINRESRX2_BUTTERFLY
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
  ...
  COMPONENT fft_filters_MINRESRX2FFT_MEMSEL
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
  ...
  COMPONENT fft_filters_MINRESRX2FFT_CTRL
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
          din_1_re                        :   IN    std_logic_vector(30 DOWNTO 0);  -- sfix31_En23
  ...
  COMPONENT fft_filters_MINRESRX2FFT_OUTMux
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
          rdEnb1                          :   IN    std_logic;
  ...
  FOR ALL : fft_filters_TWDLROM
    USE ENTITY work.fft_filters_TWDLROM(rtl);

  FOR ALL : fft_filters_MINRESRX2FFT_MEMORY
    USE ENTITY work.fft_filters_MINRESRX2FFT_MEMORY(rtl);

  FOR ALL : fft_filters_MINRESRX2FFT_BTFSEL
    USE ENTITY work.fft_filters_MINRESRX2FFT_BTFSEL(rtl);

  FOR ALL : fft_filters_MINRESRX2_BUTTERFLY
    USE ENTITY work.fft_filters_MINRESRX2_BUTTERFLY(rtl);

  FOR ALL : fft_filters_MINRESRX2FFT_MEMSEL
    USE ENTITY work.fft_filters_MINRESRX2FFT_MEMSEL(rtl);

  FOR ALL : fft_filters_MINRESRX2FFT_CTRL
    USE ENTITY work.fft_filters_MINRESRX2FFT_CTRL(rtl);

  FOR ALL : fft_filters_MINRESRX2FFT_OUTMux
    USE ENTITY work.fft_filters_MINRESRX2FFT_OUTMux(rtl);
...
BEGIN
  u_MinResRX2FFT_TWDLROM : fft_filters_TWDLROM
    PORT MAP( clk => clk,
              reset => reset,
  ...
  u_MinResRX2FFT_MEMORY : fft_filters_MINRESRX2FFT_MEMORY
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
  ...
  u_MinResRX2FFT_BTFSEL : fft_filters_MINRESRX2FFT_BTFSEL
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
  ...
  u_MinResRX2FFT_BUTTERFLY : fft_filters_MINRESRX2_BUTTERFLY
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
              btfIn1_re => btfIn1_re,  -- sfix31_En23
  ...
  u_MinResRX2FFT_MEMSEL : fft_filters_MINRESRX2FFT_MEMSEL
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
              btfOut1_re => btfOut1_re,  -- sfix31_En23
  ...
  u_MinResRX2FFT_CTRL : fft_filters_MINRESRX2FFT_CTRL
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
              din_1_re => std_logic_vector(dtc_re),  -- sfix31_En23
  ...
  u_MinResRX2FFT_OUTMUX : fft_filters_MINRESRX2FFT_OUTMux
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
              rdEnb1 => rdEnb1,
