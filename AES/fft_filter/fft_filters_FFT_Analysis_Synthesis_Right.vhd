-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\wickh\Documents\NIH\simulink_models\models\fft_filters\hdlsrc\fft_filters\fft_filters_FFT_Analysis_Synthesis_Right.vhd
-- 
...
-- -------------------------------------------------------------
-- 
-- Module: fft_filters_FFT_Analysis_Synthesis_Right
-- Source Path: fft_filters/dataplane/FFT_Analysis_Synthesis_Right
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY fft_filters_FFT_Analysis_Synthesis_Right IS
...
END fft_filters_FFT_Analysis_Synthesis_Right;


ARCHITECTURE rtl OF fft_filters_FFT_Analysis_Synthesis_Right IS

  ATTRIBUTE multstyle : string;

  -- Component Declarations
  COMPONENT fft_filters_Analysis_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT fft_filters_Frequency_Domain_Processing_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT fft_filters_Synthesis_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : fft_filters_Analysis_block
    USE ENTITY work.fft_filters_Analysis_block(rtl);

  FOR ALL : fft_filters_Frequency_Domain_Processing_block
    USE ENTITY work.fft_filters_Frequency_Domain_Processing_block(rtl);

  FOR ALL : fft_filters_Synthesis_block
    USE ENTITY work.fft_filters_Synthesis_block(rtl);
...
BEGIN
  ...
  u_Analysis : fft_filters_Analysis_block
    PORT MAP( clk => clk,
              reset => reset,
  ...
  u_Frequency_Domain_Processing : fft_filters_Frequency_Domain_Processing_block
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
              enb => enb,
  ...
  u_Synthesis : fft_filters_Synthesis_block
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
              enb => enb,
