-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\wickh\Documents\NIH\simulink_models\models\fft_filters\hdlsrc\fft_filters\fft_filters_FFT_Filter_Coefficients.vhd
-- 
...
-- -------------------------------------------------------------
-- 
-- Module: fft_filters_FFT_Filter_Coefficients
-- Source Path: fft_filters/dataplane/FFT_Analysis_Synthesis_Left/Frequency_Domain_Processing/Apply_Complex_Gains/FFT_Filter_Coefficients
-- Hierarchy Level: 4
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
END fft_filters_FFT_Filter_Coefficients;


ARCHITECTURE rtl OF fft_filters_FFT_Filter_Coefficients IS
  ...
  COMPONENT fft_filters_Filter_ROM_Choice
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          enb_1_16_1                      :   IN    std_logic;
  ...
  FOR ALL : fft_filters_FFT_ROM_Indexing
    USE ENTITY work.fft_filters_FFT_ROM_Indexing(rtl);

  FOR ALL : fft_filters_Filter_ROM_Choice
    USE ENTITY work.fft_filters_Filter_ROM_Choice(rtl);
...
BEGIN
  ...
  u_Filter_ROM_Choice : fft_filters_Filter_ROM_Choice
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
