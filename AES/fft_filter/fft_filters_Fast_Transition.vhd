-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\wickh\Documents\NIH\simulink_models\models\fft_filters\hdlsrc\fft_filters\fft_filters_Fast_Transition.vhd
-- 
...
-- -------------------------------------------------------------
-- 
-- Module: fft_filters_Fast_Transition
-- Source Path: fft_filters/dataplane/FFT_Analysis_Synthesis_Left/Analysis/FFT Frame Buffering/Fast_Transition
-- Hierarchy Level: 4
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY fft_filters_Fast_Transition IS
...
END fft_filters_Fast_Transition;


ARCHITECTURE rtl OF fft_filters_Fast_Transition IS
...
BEGIN
  ...
  -- 
  -- Transition Signals to Fast Clock Rate
  -- 
