-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\wickh\Documents\NIH\simulink_models\models\fft_filters\hdlsrc\fft_filters\fft_filters_Gains_ROM_real_block6.vhd
-- 
...
-- -------------------------------------------------------------
-- 
-- Module: fft_filters_Gains_ROM_real_block6
-- Source Path: fft_filters/dataplane/FFT_Analysis_Synthesis_Right/Frequency_Domain_Processing/Apply_Complex_Gains/FFT_Filter_Coefficients/Filter_ROM_Choice/Complex_Gains_4_ROM/Gains_ROM_real
-- Hierarchy Level: 7
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY fft_filters_Gains_ROM_real_block6 IS
...
END fft_filters_Gains_ROM_real_block6;


ARCHITECTURE rtl OF fft_filters_Gains_ROM_real_block6 IS
...
BEGIN
  ...
  Lookup_Table_out1 <= to_signed(16#7FFFFF#, 24);
