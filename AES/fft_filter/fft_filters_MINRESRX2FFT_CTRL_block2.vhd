-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\wickh\Documents\NIH\simulink_models\models\fft_filters\hdlsrc\fft_filters\fft_filters_MINRESRX2FFT_CTRL_block2.vhd
-- 
...
-- -------------------------------------------------------------
-- 
-- Module: fft_filters_MINRESRX2FFT_CTRL_block2
-- Source Path: fft_filters/dataplane/FFT_Analysis_Synthesis_Right/Synthesis/iFFT/MINRESRX2FFT_CTRL
-- Hierarchy Level: 4
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY fft_filters_MINRESRX2FFT_CTRL_block2 IS
...
END fft_filters_MINRESRX2FFT_CTRL_block2;


ARCHITECTURE rtl OF fft_filters_MINRESRX2FFT_CTRL_block2 IS
    ...
    CASE minResRX2FFTCtrl_state IS
      WHEN "0000" =>
        ...
        IF validIn = '1' THEN 
          ...
          minResRX2FFTCtrl_dOut1Re_Reg_next <= din_1_im_signed;
          minResRX2FFTCtrl_dOut1Im_Reg_next <= din_1_re_signed;
      ...
      WHEN "0011" =>
        ...
        IF (validIn AND ( NOT minResRX2FFTCtrl_xSampleVld)) = '1' THEN 
          minResRX2FFTCtrl_xSample_re_next <= din_1_im_signed;
          minResRX2FFTCtrl_xSample_im_next <= din_1_re_signed;
