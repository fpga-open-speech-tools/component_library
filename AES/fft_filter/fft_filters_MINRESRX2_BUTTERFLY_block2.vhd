-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\wickh\Documents\NIH\simulink_models\models\fft_filters\hdlsrc\fft_filters\fft_filters_MINRESRX2_BUTTERFLY_block2.vhd
-- 
...
-- -------------------------------------------------------------
-- 
-- Module: fft_filters_MINRESRX2_BUTTERFLY_block2
-- Source Path: fft_filters/dataplane/FFT_Analysis_Synthesis_Right/Synthesis/iFFT/MINRESRX2_BUTTERFLY
-- Hierarchy Level: 4
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY fft_filters_MINRESRX2_BUTTERFLY_block2 IS
...
END fft_filters_MINRESRX2_BUTTERFLY_block2;


ARCHITECTURE rtl OF fft_filters_MINRESRX2_BUTTERFLY_block2 IS

  -- Component Declarations
  COMPONENT fft_filters_Complex4Multiply_block2
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
          btfIn2_re                       :   IN    std_logic_vector(30 DOWNTO 0);  -- sfix31_En23
  ...
  FOR ALL : fft_filters_Complex4Multiply_block2
    USE ENTITY work.fft_filters_Complex4Multiply_block2(rtl);
...
BEGIN
  u_MUL4 : fft_filters_Complex4Multiply_block2
    PORT MAP( clk => clk,
              reset => reset,
