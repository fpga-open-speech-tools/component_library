-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\wickh\Documents\NIH\simulink_models\models\fft_filters\hdlsrc\fft_filters\fft_filters_addr_B_gen_block.vhd
-- 
...
-- -------------------------------------------------------------
-- 
-- Module: fft_filters_addr_B_gen_block
-- Source Path: fft_filters/dataplane/FFT_Analysis_Synthesis_Right/Analysis/FFT Frame Buffering/addr_B_gen
-- Hierarchy Level: 4
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
END fft_filters_addr_B_gen_block;


ARCHITECTURE rtl OF fft_filters_addr_B_gen_block IS
  ...
  FOR ALL : fft_filters_addr_B_gen_enable_block
    USE ENTITY work.fft_filters_addr_B_gen_enable_block(rtl);
