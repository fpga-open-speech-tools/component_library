-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\wickh\Documents\NIH\simulink_models\models\fft_filters\hdlsrc\fft_filters\fft_filters_addr_B_gen_enable_block.vhd
-- 
...
-- -------------------------------------------------------------
-- 
-- Module: fft_filters_addr_B_gen_enable_block
-- Source Path: fft_filters/dataplane/FFT_Analysis_Synthesis_Right/Analysis/FFT Frame Buffering/addr_B_gen/addr_B_gen_enable
-- Hierarchy Level: 5
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
END fft_filters_addr_B_gen_enable_block;


ARCHITECTURE rtl OF fft_filters_addr_B_gen_enable_block IS
