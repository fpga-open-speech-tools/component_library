-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\wickh\Documents\NIH\simulink_models\models\fft_filters\hdlsrc\fft_filters\fft_filters_iFFT.vhd
-- 
...
-- -------------------------------------------------------------
-- 
-- Module: fft_filters_iFFT
-- Source Path: fft_filters/dataplane/FFT_Analysis_Synthesis_Left/Synthesis/iFFT
-- Hierarchy Level: 3
-- 
-- FFT HDL Optimized
-- 
...
END fft_filters_iFFT;


ARCHITECTURE rtl OF fft_filters_iFFT IS

  -- Component Declarations
  COMPONENT fft_filters_TWDLROM_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
  ...
  COMPONENT fft_filters_MINRESRX2FFT_MEMORY_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
  ...
  COMPONENT fft_filters_MINRESRX2FFT_BTFSEL_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
  ...
  COMPONENT fft_filters_MINRESRX2_BUTTERFLY_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
  ...
  COMPONENT fft_filters_MINRESRX2FFT_MEMSEL_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
  ...
  COMPONENT fft_filters_MINRESRX2FFT_CTRL_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
          din_1_im                        :   IN    std_logic_vector(30 DOWNTO 0);  -- sfix31_En23
  ...
  COMPONENT fft_filters_MINRESRX2FFT_OUTMux_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
          rdEnb1                          :   IN    std_logic;
  ...
  FOR ALL : fft_filters_TWDLROM_block
    USE ENTITY work.fft_filters_TWDLROM_block(rtl);

  FOR ALL : fft_filters_MINRESRX2FFT_MEMORY_block
    USE ENTITY work.fft_filters_MINRESRX2FFT_MEMORY_block(rtl);

  FOR ALL : fft_filters_MINRESRX2FFT_BTFSEL_block
    USE ENTITY work.fft_filters_MINRESRX2FFT_BTFSEL_block(rtl);

  FOR ALL : fft_filters_MINRESRX2_BUTTERFLY_block
    USE ENTITY work.fft_filters_MINRESRX2_BUTTERFLY_block(rtl);

  FOR ALL : fft_filters_MINRESRX2FFT_MEMSEL_block
    USE ENTITY work.fft_filters_MINRESRX2FFT_MEMSEL_block(rtl);

  FOR ALL : fft_filters_MINRESRX2FFT_CTRL_block
    USE ENTITY work.fft_filters_MINRESRX2FFT_CTRL_block(rtl);

  FOR ALL : fft_filters_MINRESRX2FFT_OUTMux_block
    USE ENTITY work.fft_filters_MINRESRX2FFT_OUTMux_block(rtl);
...
BEGIN
  u_MinResRX2FFT_TWDLROM : fft_filters_TWDLROM_block
    PORT MAP( clk => clk,
              reset => reset,
  ...
  u_MinResRX2FFT_MEMORY : fft_filters_MINRESRX2FFT_MEMORY_block
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
  ...
  u_MinResRX2FFT_BTFSEL : fft_filters_MINRESRX2FFT_BTFSEL_block
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
  ...
  u_MinResRX2FFT_BUTTERFLY : fft_filters_MINRESRX2_BUTTERFLY_block
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
              btfIn1_re => btfIn1_re,  -- sfix31_En23
  ...
  u_MinResRX2FFT_MEMSEL : fft_filters_MINRESRX2FFT_MEMSEL_block
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
              btfOut1_re => btfOut1_re,  -- sfix31_En23
  ...
  u_MinResRX2FFT_CTRL : fft_filters_MINRESRX2FFT_CTRL_block
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
              din_1_im => dataIn_im,  -- sfix31_En23
  ...
  u_MinResRX2FFT_OUTMUX : fft_filters_MINRESRX2FFT_OUTMux_block
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
              rdEnb1 => rdEnb1,
