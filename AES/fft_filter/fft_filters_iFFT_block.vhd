-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\wickh\Documents\NIH\simulink_models\models\fft_filters\hdlsrc\fft_filters\fft_filters_iFFT_block.vhd
-- 
...
-- -------------------------------------------------------------
-- 
-- Module: fft_filters_iFFT_block
-- Source Path: fft_filters/dataplane/FFT_Analysis_Synthesis_Right/Synthesis/iFFT
-- Hierarchy Level: 3
-- 
-- FFT HDL Optimized
-- 
...
ARCHITECTURE rtl OF fft_filters_iFFT_block IS
  ...
  FOR ALL : fft_filters_TWDLROM_block2
    USE ENTITY work.fft_filters_TWDLROM_block2(rtl);

  FOR ALL : fft_filters_MINRESRX2FFT_MEMORY_block2
    USE ENTITY work.fft_filters_MINRESRX2FFT_MEMORY_block2(rtl);

  FOR ALL : fft_filters_MINRESRX2FFT_BTFSEL_block2
    USE ENTITY work.fft_filters_MINRESRX2FFT_BTFSEL_block2(rtl);

  FOR ALL : fft_filters_MINRESRX2_BUTTERFLY_block2
    USE ENTITY work.fft_filters_MINRESRX2_BUTTERFLY_block2(rtl);

  FOR ALL : fft_filters_MINRESRX2FFT_MEMSEL_block2
    USE ENTITY work.fft_filters_MINRESRX2FFT_MEMSEL_block2(rtl);

  FOR ALL : fft_filters_MINRESRX2FFT_CTRL_block2
    USE ENTITY work.fft_filters_MINRESRX2FFT_CTRL_block2(rtl);

  FOR ALL : fft_filters_MINRESRX2FFT_OUTMux_block2
    USE ENTITY work.fft_filters_MINRESRX2FFT_OUTMux_block2(rtl);
